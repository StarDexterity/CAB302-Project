...
public class DatabaseConnection {
     ...
     * @return {@link Triplet} with url, username, and password from db.props
     */
     ...
     * If the maze doesn't have an ID, creates an entry in the database
     * and gives it the auto-incremented id generated by the database
    ...
    /**
     * Uploads the images of a given maze to the database
     */
    ...
    /**
     * Retrieves an individual maze from the database by its ID
     * @param mazeID The ID of the maze to be retrieved.
     * @return The retrieved {@link Maze}.
     */
    ...
    /**
     * Places images retrieved from the database into the given maze.
     * @param maze The {@link Maze} to insert images into.
     */
    ...
    /**
     * Retrieves the {@link MazeData} of all mazes in the database.
     * @return An {@link ArrayList} containing the retrieved {@link MazeData}
     */
    ...
    /**
     * Converts a {@link Serializable} object to a {@link Blob}.
     */
    ...
    /**
     * Converts a {@link ByteArrayOutputStream} to a {@link Blob}.
     */
    ...
    /**
     * Converts a {@link Blob} to a {@link ByteArrayOutputStream}.
     */
    ...
    /**
     * Converts a {@link Blob} to an {@link Object}.
     */
